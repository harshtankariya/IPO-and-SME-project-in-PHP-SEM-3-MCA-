    ...
    <div class="d-flex">
        ...
        <div class="container-fluid">
            <div class="form-container shadow">
                <h2 class="text-center mb-4">SME Data Entry Form</h2>
                <form action="sme_data.php" method="POST">
                    <div class="row mb-3">
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="ipo_name" class="form-control" required>
                        </div>
                    </div>
...
<!-- /// date validation code here  backup code ////////////////////////////////////////////////
<div class="col-md-6">
    <label class="form-label">Listing Date</label>
    <input type="date" id="listing_date" name="listing_date" class="form-control" required>
</div>
