...
<body>
  ...
  <div class="d-flex">
    ...
    <div class="sidebar d-none d-md-block">
      <a class="nav-link active" href="home.php"><i class="bi bi-funnel"></i>All Ipo </a>
      <a class="nav-link" href="current_ipo.php"><i class="bi bi-broadcast"></i> Current IPOs</a>
      <a class="nav-link" href="upcoming_ipo.php"><i class="bi bi-calendar-event"></i> Upcoming IPOs</a>
      <a class="nav-link" href="listed_ipo.php"><i class="bi bi-list-task"></i> Listed IPOs</a>
    </div>
    ...
    <div class="container-fluid p-4">
      <div class="row g-4">
        ...
        $result = $conn->query("SELECT * FROM ipo_data_add ORDER BY IPO_ID DESC");
        if (!$result) {
          ...
          <div class="col-lg-4 col-md-6">
            <div class="ipo-card">
              <h6 class="mb-3 ipo-id">
                <span class="badge bg-primary">IPO Name : <?= htmlspecialchars($row['Name_ipo']) ?></span>
              </h6>
