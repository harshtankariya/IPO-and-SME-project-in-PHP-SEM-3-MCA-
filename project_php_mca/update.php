...
try {
    ...
    if (!isset($_GET['IPO_ID'])) {
        die("Error: SME IPO ID not provided.");
    }

    $ipo_id = $_GET['IPO_ID'];

    // Fetch record
    $sql = "SELECT * FROM sme_data_add WHERE IPO_ID = :IPO_ID"; 
...
<head>
    <meta charset="UTF-8">
    <title>Update SME IPO</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body class="bg-light">
<div class="container mt-5">
    <div class="card shadow p-4">
        <h2 class="text-center mb-4">Update SME IPO Data</h2>
        <form action="update_data.php" method="POST">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label class="form-label">SME Name</label>
            ...
            <div class="text-center mt-4">
                ...
                <a href="sme_disp_admin.php" class="btn btn-secondary px-4">Cancel</a>
            </div>
        </form>
    </div>
</div>
