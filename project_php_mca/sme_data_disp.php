...
<body>
  ...
  <div class="d-flex">
    ...
    <div class="sidebar d-none d-md-block">
      <a class="nav-link active" href="#"><i class="bi bi-funnel"></i> Filter</a>
    ...
    <div class="container-fluid p-4">
      <div class="row g-4">
        ...
        // ✅ use your correct table: ipo_data
        $result = $conn->query("SELECT * FROM sme_data_add ORDER BY IPO_ID DESC");
        if (!$result) {
